...
RSpec.describe Api::TransactionOutputsController, type: :controller do
  describe "POST #create" do
    ...
    it "returns http created if the user created succesfuly a transaction output" do
      login_as employee.user
    ...
    it "returns http unprocessable_entity if the user don't have enough points" do
      login_as employee.user
