...
RSpec.describe Api::TransactionInputsController, type: :controller do
  describe "POST #create" do
    ...
    it "returns http not_found if the user with national_id X not found" do
      login_as partner
    ...
    it "returns http unprocessable_entity if the user is assigning himself" do
      login_as partner
      post :create, params: {transaction_input: {national_id: partner.national_id, points: 10, invoice_number: "123123123"}} , :format => :json
